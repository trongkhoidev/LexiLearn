...
const NAV_ITEMS = [
  ...
  { label: 'TEACHER', role: 'teacher', items: [
    ...
    { icon: 'test', text: 'Exam Library', route: '/exams' },
    { icon: 'materials', text: 'Materials', route: '/materials' },
    { icon: 'grading', text: 'Grading Hub', route: '/grading-hub' },
    { icon: 'desk', text: 'Shared Desk', route: '/shared-desk' },
  ]},
  { label: 'MY LEARNING', role: 'student', items: [
    { icon: 'assignments', text: 'My Assignments', route: '/my-assignments' },
    { icon: 'test', text: 'My Exams', route: '/exams' },
    { icon: 'desk', text: 'Personal Desk', route: '/personal-desk' },
    { icon: 'reading', text: 'Topics', route: '/topics' },
    { icon: 'grading', text: 'Performance', route: '/analytics' },
  ]},
  { label: 'STUDY', items: [
    { icon: 'decks', text: 'My Decks', route: '/decks' },
    { icon: 'reading', text: 'Reading Practice', route: '/reading', role: 'student' },
    { icon: 'test', text: 'Cambridge Library', route: '/cambridge', role: 'teacher' },
  ]},
];
...
function renderBase(sidebar, current, dueCount) {
  sidebar.innerHTML = `
    ...
    <nav class="sidebar-nav">
      ${NAV_ITEMS
        ...
        ${section.items
          .filter(item => !item.role || getCurrentUser()?.role === item.role)
          .map(item => `
  ...
  // Notifications + user menu are rendered in TopRightBar now.
